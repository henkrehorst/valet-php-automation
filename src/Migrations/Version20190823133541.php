 ...
 */
final class Version20190823133541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE platform (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(30) NOT NULL, ci_cd VARCHAR(30) NOT NULL, image_name VARCHAR(30) NOT NULL, status VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `update` (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', php_version_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', release_version VARCHAR(8) NOT NULL, package_hash VARCHAR(64) NOT NULL, rebuild_version INT NOT NULL, type VARCHAR(30) NOT NULL, status VARCHAR(30) NOT NULL, branch VARCHAR(50) NOT NULL, INDEX IDX_9825357881E24D4 (php_version_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `update` DROP FOREIGN KEY FK_9825357881E24D4');
